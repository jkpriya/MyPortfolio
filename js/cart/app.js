...
const app = express()
const port = 3000
const productCatalogManagerModule = require('./productCatalogManager')
const prodCatalogManager = new productCatalogManagerModule(products);

const cartManagerModule = require('./cartManager')
const cartManager = new cartManagerModule();

const priceCalculatorModule = require('./priceCalculator')
